...
object TextViewUtil {
    ...
    fun isNeedAjust(textView: TextView?): Boolean {
        if (textView == null) {
            return false
        }
    ...
    private fun logline(textView: TextView) {
        Log.d(
            "MainActivity", "mViewHeight:" + mViewHeight_PX + "--- mLayout" + mLayout
                    + "-----textView.lineHeight:" + textView.lineHeight
                    + "--- mLayout.getLineTop($textView.maxLines):" + mLayout!!.getLineTop(textView.maxLines)
        )
